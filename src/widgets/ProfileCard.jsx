...
function ProfileCard({ userId }) {
  ...
  return (
    <Card>
      <div className='flex'>
        <header className='flex flex-1 gap-6'>
          {/* Profile Image */}
          ...
          <div className='flex flex-1 flex-col justify-center'>
            ...
            <span className='font-sans text-gray-600 text-lg'>BS Information Technology</span>
          </div>
        </header>
          ...
          <dl className='flex gap-4 justify-end h-full'>
            ...
            <div className='flex flex-col-reverse justify-center items-center w-48 py-4 border border-gray-500 rounded-lg'>
              ...
              <div className='flex gap-1 items-center'>
                ...
                <span class='material-symbols-outlined text-accent-500'>star</span>
              </div>
            </div>
            
            {/* Books Listed */}
            <div className='flex flex-col-reverse justify-center items-center w-48 py-4 rounded-lg bg-gray-200'>
